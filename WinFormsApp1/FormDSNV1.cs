        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!Functions.Functions.CheckKey(sql))
                {
                    ...
                    sql = "INSERT INTO [qlbhth2].[dbo].[tbl_nhanvien]([MaNV],[TenNV],[Giới tính],[DiaChi],[DienThoai],[NgaySinh],[LoaiLuong],[ChucVu],[Ava]) VALUES (N'" + txtId.Text.Trim() + "',N'" + txtName.Text.Trim() + "',N'" + checkBox() + "',N'" + txtDiaChi.Text + "','" + txtSdt.Text + "','" + dateNgaySinh.Value.Date.ToString("dd/MM/yyyy") + "',N'" + a + "',N'" + b + "',@image)";
